...
To detect when the device is stolen we used the accelerometer sensor to recognize movements. The accelerometer measures the acceleratoin of the three dimensions of space (cf. \rfig{axis}). For each of the dimension, we measured the acceleration and compare them to some threshold. This was necessarily because the sensor registers very small changes in acceleration. Certainly we do not want to monitor very small changes and trigger fake alarm.
